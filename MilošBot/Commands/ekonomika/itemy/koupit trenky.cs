...
{
    public class KoupitTrenky : ModuleBase<SocketCommandContext>
    {
        private const int cena = 20_000;

        [Command("spálit-trenky")]
        [Alias("koupit-tr", "buy-tr", "buy-trenky", "3")]
        [FormatSummary("Koupí spálené červené trenky za {0} peněz.", cena)]
        public async Task KoupitTrenkyAsync()
        {
            ...
            {
                await Context.Message.Channel.SendMessageAsync("Už nejspíše vlastníš popel z červených trenek");
                return;
            }
            ...
            int uzivatel55 = cisla.cervenetrenyrky;
            ...
            var update1 = Builders<BsonDocument>.Update.Set("cervenetrenyrky", slovo6);
