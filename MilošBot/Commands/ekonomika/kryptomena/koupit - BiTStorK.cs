...
{
    public class helpjkltdjllklost : ModuleBase<SocketCommandContext>
    {
        [Command("koupit-BiTStorK")]
        public async Task Kickáásdsdsdsaswewdsaenzou([Remainder] int i = 0)
        {
            if (i >= 1)
            {
                ...
                if (kurz * i <= banka)
                {
                    ...
                    await cons1.SendMessageAsync("koupit BiTStorK " + ruka);
                    ...
                    var update9 = Builders<Rootobject1>.Update.Set("5 ", secondsLeft);
                    ...
                    await Context.Channel.SendMessageAsync("právě si jsi koupil " + i + " investičních mincí kryptoměny BiTStorK v kurzu 1:" + kurz + " za " + vysledek + " STORKSCOINU");
                }
